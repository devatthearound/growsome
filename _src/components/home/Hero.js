    ...
    <HeroSection id="hero">
      <FloatingAgents>
        <FloatingAgent left="20%" top="15%">
          <img src="images/home/ai-agent1.png" alt="Floating Agent 1"  />
        </FloatingAgent>
        <FloatingAgent right="25%" top="40%">
          <img src="images/home/ai-agent2.png" alt="Floating Agent 2" />
        </FloatingAgent>
        <FloatingAgent left="35%" bottom="20%">
          <img src="images/home/ai-agent3.png" alt="Floating Agent 3" />
        </FloatingAgent>
      </FloatingAgents>
      <HeroContent>
        <motion.div
...
const FloatingAgent = styled.div`
  position: absolute;
  width: 200px;
  height: 200px;
  border-radius: 20px;
