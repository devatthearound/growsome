...
interface AffiliateSettingsPopupProps {
  onSubmit: (settings: any) => void;
  onClose: () => void;
  currentSettings: any;
}

const AffiliateSettingsPopup = ({ onSubmit, onClose, currentSettings }: AffiliateSettingsPopupProps) => {
        ...
        <TabContent>
          {activeTab === 'coupang' && (
            <Form onSubmit={handleSubmit}>
              ...
              <ButtonGroup>
                <SaveButton type="submit" $disabled={false}>저장</SaveButton>
                <CancelButton type="button" onClick={onClose} $disabled={false}>취소</CancelButton>
              </ButtonGroup>
            </Form>
          )}
        </TabContent>
