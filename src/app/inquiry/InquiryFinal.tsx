    ...
    <FinalContent>
      ...
      <SummarySection>
        ...
        <SummaryList>
          ...
          <SummaryItem>
            <Label>준비 단계</Label>
            <Value>{preparationText[selectedPreparation as keyof typeof preparationText] || selectedPreparation}</Value>
          </SummaryItem>
          <SummaryItem>
            <Label>개발 방법</Label>
            <Value>{methodText[selectedMethod as keyof typeof methodText] || selectedMethod}</Value>
          </SummaryItem>
          <SummaryItem>
            <Label>예산</Label>
            <Value>{budgetText[selectedBudget as keyof typeof budgetText] || selectedBudget}</Value>
          </SummaryItem>
          <SummaryItem>
            <Label>비즈니스 모델</Label>
